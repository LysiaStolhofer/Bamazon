...
connection.connect(function (err) {
    if (err) throw err;
    clearScreen()
    console.log("\033[32m", "Welcome to Bamazon.", "\x1b[0m\n");
    ...
    inquirer.prompt([
        ...
        connection.query("SELECT * FROM products WHERE item_id=?", [itemID_selected], function (err, res) {
            ...
            if (itemQuantity_selected > res[0].stock_quantity) {
                ...
                console.log("\n----------------------------------------------------------------\n");
                console.log("\033[31m", "Sorry, Your number of request is not available right now.", "\x1b[0m\n");
                console.log("\033[31m", "we have only", "\x1b[0m" + res[0].stock_quantity + "\033[31m", "items in our stock at the moment.", "\x1b[0m\n");
                console.log("\n----------------------------------------------------------------\n");
                if (another_item === "y") {
                    showProducts();
                } else {
                ...
                console.log("\033[32m", "Dankeschön for your Shopping!", "\x1b[0m\n");
                console.log("\n----------------------------\n");
